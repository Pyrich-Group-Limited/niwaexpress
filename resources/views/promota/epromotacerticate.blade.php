        ...
        <div class="second">
            <div class="third">
                ...
                <div class="content-div">
                    ...
                    <div>
                        <form action="">
                            <div class="part-1">
                                ...
                                <p>{{ auth()->user()->contact_firstname . ' ' .auth()->user()->contact_surname }}</p>
                                {{-- <p class="grey-color">with </p>
                                <p>{{auth()->user()->contact_firstname  }}</p><br> --}}
                            </div>
                            <div class="part-2">
                                <label for="" class="grey-color">is fully Registered as e-Promota Agent</label><br>
                    ...
                    <div class="signature" style="margin-bottom: 0px;padding-bottom: 0px;">
                        <div class="row" style="margin-bottom: 0px;padding-bottom: 0px;">
                            <div class="col sig">
                                <label for="">Issued on:</label><br>
                                <span> {{ date('M d, Y', strtotime(auth()->user()->created_at )) }}</span><br>
                                {{-- <label for="">Expired on:</label><br>
                                <span> {{ date('M d, Y', strtotime($service_application->expiry_date)) }}</span> --}}
                    ...
                    <div class="cert_no">
                        <p><label for="">Permit No: </label> {{auth()->user()->applicant_code}} </p>
                    </div>
                </div>
